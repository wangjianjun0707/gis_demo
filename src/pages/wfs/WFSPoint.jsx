    ...
    fetch("http://localhost:8000/arcgis/services/testwfs/MapServer/WFSServer", {
      ...
      .then(function(data) {
        let gml = new WFS({
          ...
          schemaLocation:
            "http://www.opengis.net/gml http://schemas.opengis.net/gml/3.2.1/gml.xsd http://www.opengis.net/ogc http://schemas.opengis.net/filter/2.0/filter.xsd http://www.opengis.net/ows/1.1 http://schemas.opengis.net/ows/1.1.0/owsAll.xsd http://www.opengis.net/wfs/2.0 http://schemas.opengis.net/wfs/2.0/wfs.xsd http://www.opengis.net/fes/2.0 http://schemas.opengis.net/filter/2.0/filterAll.xsd",
          gmlFormat: new GML3({
            featureNS:
              "http://localhost:6080/arcgis/services/testwfs/MapServer/WFSServer",
            featureType: "SDE.LEGAL_PERSON_COLLECTION_INFO",
