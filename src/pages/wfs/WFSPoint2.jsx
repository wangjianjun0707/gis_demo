...
export default class WFSPoint2 extends React.Component {
  componentDidMount() {
    const wmsUrl = 'http://localhost:8000/arcgis/services/LSZT/MapServer/WMSServer';
    ...
    let vectorSource = new VectorSource({
      ...
      loader: function (extent, resolution, projection) {
        let url = 'http://localhost:8000/arcgis/services/testwfs/MapServer/WFSServer?service=WFS&' +
